...
public class IsoTestClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sendAndReceive(buildMessage(factory, "000000005000", "000001", "REF000000001"));

        Thread.sleep(300);

        // Test 2: Decline N150.00
        System.out.println("\nTEST 2: Amount N150.00 → Expected: DECLINE (05)");
        sendAndReceive(buildMessage(factory, "000000015000", "000002", "REF000000002"));

        Thread.sleep(300);

        // Test 3: Boundary exactly N100.00
        System.out.println("\nTEST 3: Amount N100.00 → Expected: APPROVE (00)");
        sendAndReceive(buildMessage(factory, "000000010000", "000003", "REF000000003"));

        Thread.sleep(300);

        // Test 4: Just over boundary — N100.01
        System.out.println("\nTEST 4: Amount N100.01 → Expected: DECLINE (05)");
        sendAndReceive(buildMessage(factory, "000000010001", "000004", "REF000000004"));
    }
